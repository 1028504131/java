...
&nbsp;
 ...
 第<select onchange="location.href='${pageContext.request.contextPath}/${page.url}?${page.params}&pageNum='+this.value+'&pageSize=${page.pageSize}'">
...
每页
<select onchange="location.href='${pageContext.request.contextPath}/${page.url}?${page.params}&pageNum=${page.pageNum}&pageSize='+this.value">
	<option value="5" ${page.pageSize eq 5?"selected":""}>5</option>
	<option value="6" ${page.pageSize eq 6?"selected":""}>6</option>
	<option value="7" ${page.pageSize eq 7?"selected":""}>7</option>
	<option value="8" ${page.pageSize eq 8?"selected":""}>8</option>
	<option value="9" ${page.pageSize eq 9?"selected":""}>9</option>
